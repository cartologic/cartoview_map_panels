...
class ConfigForm(forms.ModelForm):
    ...
    left_panel_title = forms.CharField(required=False)
    left_panel_content = forms.CharField(widget=forms.Textarea, required=False)

    show_top_panel = forms.BooleanField(required=False)
    top_panel_title = forms.CharField(required=False)
    top_panel_content = forms.CharField(widget=forms.Textarea, required=False)

    show_right_panel = forms.BooleanField(required=False)
    right_panel_title = forms.CharField(required=False)
    ...
    bottom_panel_title = forms.CharField(required=False)
    ...
    class Media:
        # css = {all:[]}
        js = [static(APP_NAME + "/js/config_form.js")]
